...
class ShapesTest(unittest.TestCase):
    ...
    def test_sum_shapes_areas(self):
        shapes: List[Shape] = [Circle(1), Rectangle(5, 5), Triangle(10, 10, 10)]
        total_area: float = Shape.sum_areas(shapes)
        assert math.isclose(total_area, math.pi + 25 + 4.33)
